...
public class RecruitController {
	...
	public Result recommand(){
		List<Recruit> recruits = recruitService.findTop6ByStateOrderByCreatetimeDesc("2");
		return new Result(true,StatusCode.OK,"推荐职位",recruits);
	}
	...
	public Result newlist(){
		...
		return new Result(true,StatusCode.OK,"最新职位",recruits);
	}
}
